                ...
                <tr>
                    <td align="center" valign="top" style="margin:0;padding:0;">
                        <table border="0" cellpadding="0" cellspacing="0" align="center" data-editable="image"
                            ...
                            <tr>
                                <td>
                                    <img src="https://cdn.iwes.it/assets/missing.jpg" alt="" width="640px" border="0"
                                         style="border-width: 0px; border-style: none; border-color: transparent; font-size: 12px; display: block;">
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table align="center" width="620px" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                       <?php echo sprintf($data->hallo, $order->user->getName()) ?>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    style="padding: 5px 10px; margin: 0px; line-height: 1; font-size: 16px; font-family: Times New Roman, Times, serif;">
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                       <?php echo sprintf($data->line2,$coupon->amount); ?>
                                    </span>
                            ...
                            <tr>
                                <td valign="top" align="center" class="lh-3"
                                    style="padding: 10px 0 10px; margin: 0px; line-height: 1; font-size: 16px; font-family: Times New Roman, Times, serif;">
                                    <span style="font-family: 'Poppins', sans-serif; font-size:18px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                       <span style="font-weight:600"><?php echo $coupon->code ?></span>
                                    </span>
                            ...
                            <?php if (!empty($products)): ?>
                                <tr>
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:600;color:#3A3A3A; line-height:2;">
                                           <?php echo $data->line4 ?>
                                    </span>
                                    </td>
                                </tr>
                                                ...
                                                foreach ($products as $product):
                                                    ...
                                                    <td width="33%">
                                                        <a href="<?php echo $app->productUrl($product); ?>"
                                                           target="_blank"
                                                           style="font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:500;color: black; text-decoration: none; background-color: #f3f3f3; padding: 1px 30px 1px 30px;">
                                                        <img src="https://cdn.iwes.it/<?php echo $product->getPhoto(1, \bamboo\domain\entities\CProductPhoto::SIZE_THUMB) ?>"
                                                             alt="" width="100%" border="0"
                                                             style="border-width: 0px; border-style: none; border-color: transparent; font-size: 12px; display: block;" />
                                                        <h3 style="font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:500;color:#000000;margin: 3px">
                                                            <?php echo $product->productBrand->name ?>
                                                        </h3>
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        <?php echo $data->line7 ?>
                                        <br><span style="color: #AAAAAA">Pickyshop Team</span>
                                    </span>
                                </td>
                            </tr>
                            <tr>
