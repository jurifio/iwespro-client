                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        Inviamo di seguito il <?php echo $noticeCounter;?>° sollecito di pagamento della  distinta n. <?php echo $numberSlip ?> con importo iniziale € <?php echo number_format($slipTotalAmount,2,',','.') ?>
