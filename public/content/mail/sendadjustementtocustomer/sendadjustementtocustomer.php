                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        ti informiamo che abbiamo compensato la distinta di prelievo  <?php echo $numberSlip ;?> per € <?php echo number_format($slipTotalAmount,2,',','.') ?>
                                   con la Vostra Distinta Passiva  <?php echo $billRegistryActivePaymentSlipId;?> riferita alle seguenti fatture di emesse da Iwes
                                    </span>
                                </td>
                            </tr>
                            </tbody>
                ...
                <tr>
                    <td valign="top" align="center" style="padding:10px 10px 0px 10px; margin:0;">
                        <table align="center" width="620px" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                            <?php  foreach ($invoiceIds->billRegistryInvoiceId as $invoiceId){
                        ...
                        <table align="center" width="620px" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        <?php $pb=\Monkey::app()->repoFactory->create('PaymentBill')->findOneBy(['id'=>$numberSlip]);
                                        $amountRes=$pb->amountPaid;
                                        if($amountRes>0) {
                                            echo 'la differenza di compensazione risulta essere pari a Euro ' . $amountRes . ' (Vostro Avere)';
                                        }else if($amountRes==0){
                                           echo 'la differenza di compensazione risulta essere pari a Euro 0.00';

                                       }else{
                                           echo 'la differenza di compensazione risulata essere paria a Euro '. $amountRes. '(Nostro Avere)';
                                       }?>
                                    </span>
                                </td>
                            </tr>
