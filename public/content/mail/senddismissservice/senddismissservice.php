                        ...
                        <table align="center" width="620px" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        Vi Informiamo, nonostante i numerosi solleciti inviati, di non aver ricevuto il pagamento della  distinta n. <?php echo $numberSlip ?> con importo iniziale € <?php echo number_format($slipTotalAmount,2,',','.') ?>
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                      Senza ulteriore preavviso interromperemo i nostri servizi  a far data 48 ore da adesso.
                                    </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    style="padding: 10px 10px 10px; margin: 0px; line-height: 1.5; font-size: 16px; font-family: Times New Roman, Times, serif;">
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                    il pagamento entro le 48 ore  è unica condizione per evitare la sospensione
                                    </span>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table align="center" width="620px" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td valign="top" align="left" class="lh-3"
                                    ...
                                    <span style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#3A3A3A; line-height:1.2;">
                                        <a style="font-family: 'Poppins', sans-serif; font-size:15px;font-weight:300;color:#909090; line-height:1.2" href="mailto:billing@iwes.it">billing@iwes.it</a>.
                                    </span>
                                </td>
                            </tr>
                            <tr>
