...
$productCategory=\Monkey::app()->repoFactory->create('ProductHasProductCategory')->findOneBy(['productId'=>$productId,'productVariantId'=>$productVariantId]);
...
$sql = "SELECT dp.id as dirtyProductId, 
              ...
              left join ProductHasProductCategory p on dp.productId = p.productId and dp.productVariantId=p.productVariantId
               ...
               join DirtySku  ds on dp.id = ds.dirtyProductId 
                ...
                and p.productCategoryId=".$productCategoryId."  
                 ...
                 group BY dst.shopId,dp.productId,dp.productVariantId Order BY concat(dp.productId,'-',dp.productVariantId,st.name) asc     limit 10 
  ";
$datone = [];
$i = 0;
