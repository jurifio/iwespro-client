...
$time = microtime(true);
$sql='SELECT productId,productVariantId,shopId,dateStart,startQuantity,dateEnd,endQuantity,priceActive,SUM(soldQuantity)AS soldQuantity, SUM(netTotal) AS netTotal,`year`,`month`,`day`
