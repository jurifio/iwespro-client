...
<div class="container container-fixed-lg">
    ...
    <div class="panel panel-default">
                ...
                <div>
                    <div class="pull-left">
                        ...
                        <div>
                            <div class="pull-left font-montserrat all-caps small">
                                <strong>Fattura</strong>  19/W<strong> del </strong>18-02-2020
                            </div>
                        </div>
                        <div><br>
                            <div class="pull-left font-montserrat small"><strong>Rif. Contratto N. </strong>  1 del 05-02-2020</div>
                        </div>
                        <div><br>
                            <div class="pull-left font-montserrat small"><strong></strong>
                            </div>
                        </div>
                    </div>
                    <div class="pull-right sm-m-t-0">
                        ...
                        <div class="col-md-12 col-sm-height sm-padding-20">
                            <p class="small no-margin">Intestata a</p><h5 class="semi-bold m-t-0 no-margin">barbagallo</h5><address><strong>via catania 0<br>023145 catanaia (ct)<br>Italy<br>C.FISC. o P.IVA: 12345678900</strong></address><div class="clearfix"></div><br><p class="small no-margin"></p><address><strong><br><br><br></address></div></div></div></div><table class="table invoice-table m-t-0"><thead>
                <!--tabella prodotti-->
                <tr><th class="small">Descrizione Prodotto</th><th class="text-center small">Importo</th><th class="text-center small">iva<th class="text-center small">Importo Totale</th></th></tr></thead><tbody><tr><td class="text-center">Servizio MonkSource</td><td class="text-center">600.00 &euro;</td><td class="text-center">22%: 132.00 &euro;</td><td class="text-center">732.00 &euro;</td></tr><tr><td class="text-center">monksource-monkSource<br>monksource servizi hosting<br></td><td class="text-center">600.00 &euro;</td><td class="text-center">22%: 132.00 &euro;</td><td class="text-center">732.00 &euro;</td></tr><tr><td class="text-center">monksource-monkSource<br>monksource servizi hosting<br></td><td class="text-center">600.00 &euro;</td><td class="text-center">22%: 132.00 &euro;</td><td class="text-center">732.00 &euro;</td></tr><tr><td class="text-center">monksource-monkSource<br>monksource servizi hosting<br></td><td class="text-center">600.00 &euro;</td><td class="text-center">22%: 132.00 &euro;</td><td class="text-center">732.00 &euro;</td></tr><tr><td class="text-center">monksource-monkSource<br>monksource servizi hosting<br></td><td class="text-center">600.00 &euro;</td><td class="text-center">22%: 132.00 &euro;</td><td class="text-center">732.00 &euro;</td></tr></tbody><br><tr class="text-left font-montserrat small">
                    <td style="border: 0px"></td>
                    <td style="border: 0px"></td>
                    <td style="border: 0px">
                        <strong>Totale Netto</strong></td>
                    <td style="border: 0px"
                        class="text-center">3000.00 &euro;</td>
                </tr><tr style="border: 0px" class="text-left font-montserrat small hint-text">
                    <td style="border: 0px"></td>
                    <td style="border: 0px"></td>
                    <td style="border: 0px">
                        <strong>Totale Tasse</strong></td><td style="border: 0px" class="text-center">660.00 &euro;</td></tr><tr style="border: 0px" class="text-left font-montserrat small hint-text">
                    <td style="border: 0px"></td>
                    <td style="border: 0px"></td>
                    <td style="border: 0px">
                        <strong>Totale Dovuto</strong></td><td style="border: 0px" class="text-center">3660.00 &euro;</td></tr><tr style="border: 0px" class="text-center">
                    <td colspan="2" style="border: 0px">Modalità di pagamento Bonifico 30/60gg d.f.</td> <td style="border: 0px"></td> <td style="border: 0px"></td></tr><tr style="border: 0px" class="text-center">
                    <td colspan="2" style="border: 0px">1830.00  &euro; da corrisponedere entro il 19-03-2020</td> <td style="border: 0px"></td> <td style="border: 0px"></td></tr><tr style="border: 0px" class="text-center">
                    <td colspan="2" style="border: 0px">1830.00  &euro; da corrisponedere entro il 18-05-2020</td> <td style="border: 0px"></td> <td style="border: 0px"></td></tr></table>
        </div>
        <br>
        <br>
        <br>
        ...
        <br>
        <div>
            <center><img alt="" class="invoice-thank" data-src-retina="/assets/img//assets/img/invoicethankyou.jpg"
                         data-src="/assets/img//assets/img/invoicethankyou.jpg" src="/assets/img//assets/img/invoicethankyou.jpg">
            </center>
        </div>
        <br>
        <br>
