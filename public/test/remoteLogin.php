...
\Monkey::app()->authManager->persistAuthToken($user->id, \Monkey::app()->authManager->getToken()->getToken());
...
//Monkey::app()->authManager->prepareAuthCookie('.dev.iwes.pro', time() + (60 * 60 * 24 * 365), '/', $secureCookie, true);
/*if (empty($this->app->router->request()->getRequestData('remember'))) {
    $cookie->setExpire(0);
}*/
