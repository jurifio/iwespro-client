...
//$product = $ninetyNineMonkey->repoFactory->create('Product')->findOne([10942,33129]);

$c = new \bamboo\core\ebay\api\trading\call\CEbayReviseFixedPriceItemCall($configDev);
try {
	...
	$i->getStartPrice()->setValue(100.00);//$product->getDisplayPrice()
	...
	*/
	...
	foreach ($skus as $skuSize) {
		...
		$variation->setQuantity(($skuSize['qty']-1));
