...
$fileNomePart=$productId.'-'.$productVariantId.'_fb_'.$position.'.jpg';
$fileNome=$tempFolder.$productId.'-'.$productVariantId.'_fb_'.$position.'.jpg';
...
if($res) {
    ...
    $editorialPlanArgument = $editorialPlanArgumentRepo->findOneBy(['id' => 11]);
