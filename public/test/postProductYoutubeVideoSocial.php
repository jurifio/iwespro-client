...
$fileNomePart=$productId.'-'.$productVariantId.'_yu_'.$position.'.mp4';
$fileNomePartThumb=$productId.'-'.$productVariantId.'_yu_thumb'.$position.'.jpg';

$fileNome=$tempFolder.$productId.'-'.$productVariantId.'_yu_'.$position.'.mp4';
...
if($res) {
    ...
    $title='Richiesta post  per  ' . $editorialPlanName . ' da app su Video Youtube ' . $fileNomePart;
    ...
    $editorialPlanDetail->editorialPlanArgumentId = 11;
    $editorialPlanDetail->title = $title;
    $editorialPlanDetail->description = 'Richiesta post  per  ' . $editorialPlanName . ' da app su Video YouTube ' . $fileNomePart;
