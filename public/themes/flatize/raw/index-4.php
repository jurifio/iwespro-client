...
<body class="pgl-fixed">
	<div id="page">
		<header>
			<div id="top">
				<div class="container">
					<p class="pull-left text-note"><i class="fa fa-phone"></i> Customer Support: +080 123 456 789</p>
			...
			<nav class="navbar navbar-default navbar-main navbar-main-drop" role="navigation">
				<div class="container">
					...
					<div class="navbar-collapse collapse navbar-left width">
						<ul class="nav navbar-nav pull-right">
							<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Home</a>
								<ul class="dropdown-menu">
									<li><a href="index-2.html">Home Version 2</a></li>
									<li><a href="index-3.html">Home Version 3</a></li>
									<li class="active"><a href="index-4.html">Home Version 4</a></li>
								</ul>
							</li>
							<li class="dropdown megamenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Shop</a>
								<div class="dropdown-menu">
									<div class="mega-menu-content">
										<div class="row">
											<div class="col-md-4 hidden menu-column">
												<h3>Trends</h3>
											...
											<div class="col-sm-4 hidden menu-column">
		...
		<div role="main" class="main">
			...
			<section class="main-slide main-slide-boxed">
				<div class="container">
					<div id="owl-third-demo" class="owl-carousel main-demo second-demo">
						<div class="item"><img src="images/content/slides/home-slider4.jpg" class="img-responsive" alt="Photo">
			...
			<!-- Begin Latest Blogs -->
			<section class="latest-blog short">
				<div class="container">
		...
		<footer class="footer">
			<div class="container">
				<div class="upper-foot">
					<ul class="list-inline list-footlinks text-center">
						<li><a href="#">Track Orders</a></li>
						<li><a href="#">FAQs</a></li>
						<li><a href="#">Services</a></li>
						<li><a href="#">Free Credit</a></li>
						<li><a href="#">ReportTerms and Conditions</a></li>
		...
		<div id="style-switcher-menu">
			...
			<div class="segment">
				<ul class="theme layouts">
					<li data-layout="boxed" class="btn btn-sm btn-black btn-active">Boxed</li>
					<li data-layout="widescreen" class="btn btn-black btn-sm">Widescreen</li>
				</ul>
			</div>
			<div class="segment">
