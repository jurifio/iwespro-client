						...
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Contact</a>
								<ul class="dropdown-menu">
									...
									<li class="active"><a href="page-contact2.html">Contact Version 2</a></li>
								</ul>
							</li>
						</ul>
					</div><!--/.nav-collapse --> 
						...
						<div class="row">
							...
							<div class="col-xs-7 col-sm-8">
								<div class="form-group">
									...
									<textarea class="form-control" id="message" name="message" rows="8" data-msg-required="Please enter your message." required></textarea>
								</div>
