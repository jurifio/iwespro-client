				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Contact</a>
								<ul class="dropdown-menu">
									<li class="active"><a href="page-contact1.html">Contact Version 1</a></li>
						...
						<div class="contact-content">
							...
							<form id="contact-form" action="../php/contact-form.php" method="POST">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-xs-6">
											...
											<input type="email" class="form-control" id="email" name="email" value="" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." required>
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="message" name="message" rows="3" data-msg-required="Please enter your message." required></textarea>
								</div>
								<div class="form-group">
