				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog</a>
								<ul class="dropdown-menu">
									<li><a href="blog-sidebar.html">Blog Sidebar</a></li>
									<li class="active"><a href="blog-mini-sidebar.html">Blog Mini Sidebar</a></li>
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-image single">
											...
											<a href="blog-single.html"><img class="img-responsive" src="images/content/blog/demo-m-6.jpg" alt="Blog"></a>
										</div>
									</div>
									<div class="col-xs-8">
									...
									<div class="col-xs-4">
										<div class="post-image">
											<div id="owl-blog-slide" class="owl-carousel owl-theme">
												<div class="item">
													<img class="img-responsive" src="images/content/blog/demo-m-3.jpg" alt="Blog">
												</div>
												<div class="item">
													<img class="img-responsive" src="images/content/blog/demo-m-4.jpg" alt="Blog">
												</div>
												<div class="item">
													<img class="img-responsive" src="images/content/blog/demo-m-5.jpg" alt="Blog">
												</div>
											</div>
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-video vimeo">
											<iframe src="//player.vimeo.com/video/28614006?color=0088CC" width="100%" height="270" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										</div>
									</div>
									<div class="col-xs-8">
								...
								<div class="row">
									<div class="col-xs-4">
										<div class="post-image single">
											...
											<a href="blog-single.html"><img class="img-responsive" src="images/content/blog/demo-m-7.jpg" alt="Blog"></a>
										</div>
									</div>
									<div class="col-xs-8">
					...
					<div class="col-md-3">
						<aside class="sidebar">
							...
							<aside class="block blk-ads">
								...
								<div class="video">
									<iframe src="//player.vimeo.com/video/28614006?color=0088CC" width="100%" height="169" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
								</div>
							</aside>
							<aside class="block blk-ads">
								<h4>Tags</h4>
