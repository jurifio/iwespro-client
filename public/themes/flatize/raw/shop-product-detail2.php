								...
								<ul class="dropdown-menu">
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											...
											<li class="active"><a href="shop-product-detail2.html">Shop - Product Detail 2</a></li>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="product-preview">
							<p><img alt="" class="img-responsive" src="images/content/products/product-1.jpg"></p>
							<p><img alt="" class="img-responsive" src="images/content/products/product-1-1.jpg"></p>
							<p><img alt="" class="img-responsive" src="images/content/products/product-1-2.jpg"></p>
						</div>
					</div>
					<div class="col-sm-6">
