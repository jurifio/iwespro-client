<?php /** @var $page \bamboo\core\theming\CPage */ ?>
<!DOCTYPE html>
...
<head>
	...
	<meta name="generator" content="<?php echo $page->getGenerator(); ?>">
	<meta name="author" content="<?php echo $page->getAuthor(); ?>">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Cartechinishop.com - Calzature, borse, gioielli, sneakers</title>
	<?php $em->trigger('header'); ?>
</head>
<body>
	<div id="page">
		<header>
								...
								<ul class="dropdown-menu">
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											...
											<li class="active"><a href="shop-list-sidebar.html">Shop List - Sidebar</a></li>
